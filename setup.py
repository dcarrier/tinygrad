...
setup(name='tinygrad',
      ...
      python_requires='>=3.8',
      ext_modules=mypycify(["tinygrad/engine/realize.py", "tinygrad/engine/schedule.py", "tinygrad/device.py", 
                            "tinygrad/tensor.py", "tinygrad/codegen/kernel.py"], verbose=True),
      extras_require={
        'llvm': ["llvmlite"],
        'arm': ["unicorn"],
